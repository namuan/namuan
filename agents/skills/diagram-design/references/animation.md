...
```bash
python3 <skill-dir>/scripts/verify-motion.py path/to/animated-diagram.html
python3 <skill-dir>/scripts/test-verify-motion.py
python3 <skill-dir>/scripts/lint-skin.py path/to/animated-diagram.html
```
