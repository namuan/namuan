...
[`assets/example-import-mermaid.html`](../assets/example-import-mermaid.html) redraws `<skill-dir>/scripts/fixtures/sample-flowchart.mmd` at `format=html`, `size=doc-inline`, `detail=balanced`, `audience=mixed`.
